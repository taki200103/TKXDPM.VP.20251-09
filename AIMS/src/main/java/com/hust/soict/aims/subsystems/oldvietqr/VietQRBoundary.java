package com.hust.soict.aims.subsystems.oldvietqr;
...
public class VietQRBoundary {
     ...
     * 
     * @param authorizationHeader Basic Auth header value (e.g., "Basic
     *                            Base64String")
     ...
     * @throws InterruptedException if request is interrupted
     */
    public String checkPaymentStatus(String accessToken, String requestString)
