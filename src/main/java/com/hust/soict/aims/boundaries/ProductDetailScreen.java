...
public class ProductDetailScreen extends JDialog {
     ...
     * 2. Strategy Pattern (ProductDetailLoader) to load and display
    ...
    public ProductDetailScreen(Frame owner, Product p) {
        ...
        String barcodeText = productWithDetails.getBarcode() != null ? productWithDetails.getBarcode()
        ...
        JLabel priceLabel = new JLabel(
                String.format("Price: %s VND", df.format((long) productWithDetails.getCurrentPrice())));
        ...
        if (productWithDetails.getOriginalValue() > productWithDetails.getCurrentPrice()) {
            JLabel originalPriceLabel = new JLabel(
                    String.format("Original: %s VND", df.format((long) productWithDetails.getOriginalValue())));
     ...
     * 2. Strategy Pattern to load product-specific details by joining with
